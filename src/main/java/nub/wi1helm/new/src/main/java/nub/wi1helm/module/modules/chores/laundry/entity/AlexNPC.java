...
import nub.wi1helm.module.modules.chores.laundry.interaction.AlexNPCInteraction;
...
public class AlexNPC extends NPC {
    ...
    private static final PlayerSkin SKIN_YES_CLOTHES = new PlayerSkin(
            ...
            "");
    ...
    private final AlexNPCInteraction interaction;

    public AlexNPC(GoalManager goalManager) {
        super(Component.text("Alex"));
        this.interaction = new AlexNPCInteraction(this, goalManager);

        // Initial skin setup (state dependent, outside of interaction logic)
        // This logic remains here as it's about the NPC's visual state, not interaction.
    ...
    /**
     * Delegates interaction setup to the dedicated interaction component.
     */
    @Override
