...
public class WireSpoolItem implements GameItem {
    @Override
    public @NotNull Tag<@NotNull Boolean> getItemTag() {
        return Tag.Boolean("module:poolside:item:wirespool");
    }
    ...
    public @NotNull ItemStack getPlayerItem(ItemManager itemManager) {
        return ItemStack.builder(Material.STRING)
                .set(DataComponents.ITEM_NAME, Component.text("Wire Spool"))
                .set(getItemTag(),true)
                .build();
    }
