package nub.wi1helm.module.modules.wizard.items;
...
public class MagicWandItem implements GameItem {

    public static Tag<@NotNull Boolean> MAGIC_WAND_TAG = Tag.Boolean("module:wizard:item:magicwand");

    @Override
    public @NotNull Tag<@NotNull Boolean> getItemTag() {
        return MAGIC_WAND_TAG;
    }
    ...
    public @NotNull ItemStack getPlayerItem(ItemManager itemManager) {
        return ItemStack.builder(Material.BREEZE_ROD)
                .set(DataComponents.ITEM_NAME, Component.text("Magic Wand"))
                .set(getItemTag(), true)
                .build();
    }
