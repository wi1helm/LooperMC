...
import nub.wi1helm.module.modules.chores.gardener.GardenerModule;
...
import nub.wi1helm.module.modules.grasseater.GrassEaterModule;
...
import nub.wi1helm.module.modules.statuepolish.StatuePolishModule;
...
public class ModuleManager implements GameService {
    ...
    public ModuleManager(WorldManager worldManager, GoalManager goalManager, EntityManager entityManager, ItemManager itemManager) {
        ...
        GardenerModule gardenerModule = register(new GardenerModule(worldManager, goalManager, entityManager, itemManager));
        ...
        StatuePolishModule statuePolishModule = register(new StatuePolishModule(worldManager, goalManager, entityManager));
        GrassEaterModule grassEaterModule = register(new GrassEaterModule(goalManager));
